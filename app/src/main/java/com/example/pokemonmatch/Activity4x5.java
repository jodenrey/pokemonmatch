...
public class Activity4x5 extends AppCompatActivity {
    ...
    public void checkEnd() {
        if (imageView11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Activity4x5.this);
            alertDialogBuilder
                    .setMessage("You finished the game in "+ textViewTimer.getText() + "!!!\nYou finshed by discovering the " + points + " pairs in " + counterTentativi + " attempts" + "\nWhat do you want to do?")
                    .setCancelable(false)
